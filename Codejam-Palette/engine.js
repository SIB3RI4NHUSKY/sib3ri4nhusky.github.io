...
// Styling
const bodyStyle = document.getElementById("body");       // Indicate active tool
const pencilStyle = document.getElementById("pencil");   // Indicate active tool
const eraseStyle = document.getElementById("erase");     // Indicate active tool
const bucketStyle = document.getElementById("bucket");   // Indicate active tool
const pickerToolStyle = document.getElementById("pickerTool");   // Indicate active tool
const minSizeStyle = document.getElementById("minSize"); // Indicate active tool
const medSizeStyle = document.getElementById("medSize"); // Indicate active tool
const maxSizeStyle = document.getElementById("maxSize"); // Indicate active tool
const actualColorStyle = document.getElementById("actualColor"); // Indicate active tool
const prevColorStyle = document.getElementById("prev-color"); // Indicate active tool
